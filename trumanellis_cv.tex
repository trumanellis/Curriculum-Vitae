...
201 East 24th St, Stop C0200 & \textit{Email:} \email{truman@ices.utexas.edu}\\
...
my own. Expertise with Linux with time on high performance computing
...
\href{https://github.com/CamelliaDPG/Camellia}{Camellia}, a C++ library for
rapid development of DPG problem formulations.
\item Added an interface to VTK output for visualization via Paraview.
\item Studying an exactly conservative formulation of DPG through Lagrange
multipliers.
...
\begin{bibsection}
    ...
    \item Dobrev, V. A., Ellis, T. E., Kolev, T. V. and Rieben, R. N. (2012), 
          High-order curvilinear finite elements for axisymmetric Lagrangian
          hydrodynamics.
          \emph{Computers and Fluids}, 
