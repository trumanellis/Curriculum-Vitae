...
\item[] Ph.D.,
        \href{http://www.ices.utexas.edu/}
             {Computational Science, Engineering, and Mathematics}, December 2014
        \begin{innerlist}
        \item Adviser:
              \href{http://users.ices.utexas.edu/~leszek/}
                   {Professor Leszek F.~Demkowicz}
        \item Area of Study: Discontinuous Petrov-Galerkin Finite Elements for Space-Time Computational Fluid Dynamics
        \end{innerlist}
...
\href{https://github.com/CamelliaDPG/Camellia}{Camellia}, a parallel C++ library for
