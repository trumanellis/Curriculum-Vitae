...
Well developed programming and development skills. 
...
\item[] Ph.D.,
        \href{http://www.ices.utexas.edu/}
             {Computational Science Engineering and Mathematics}, May 2015
        \begin{innerlist}
        \item Advisors:
              ...
              \href{http://www.me.utexas.edu/directory/faculty/moser/robert/131/}
                   {Robert~Moser}
        \item Research: Space-time discontinuous Petrov-Galerkin finite elements for transient computational fluid dynamics
        \end{innerlist}
...
\begin{bibsection}
    \item Truman Ellis, Leszek Demkowicz, Nathan Roberts, Jesse Chan, and Robert Moser (2014),\\
          Space-Time DPG: Designing a Method for Massively Parallel CFD.\\
          \emph{Computers and Fluids} (submitted)
