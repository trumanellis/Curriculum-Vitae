...
Well developed programming and development skills with an affinity for clean, well-written solutions. 
...
\item[] Ph.D.,
        ...
        \begin{innerlist}
        \item Thesis Topic: Space-time discontinuous Petrov-Galerkin finite elements for transient computational fluid dynamics
        \item Advisors:
