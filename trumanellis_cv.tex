...
\textbf{Graduate Research Assistant} -- \emph{Stabilized Finite Elements} \hfill {2010 to present}
\begin{innerlist}
...
\textbf{Graduate Student Researcher} -- \emph{Shock Hydrocodes} \hfill {2008 to 2010, 2013}
\begin{innerlist}
