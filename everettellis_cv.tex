...
Well developed programming and development skills (C++ and Python) with experience in parallel programming paradigms.
...
\item Experimental analysis of electromagnetic pulses via particle accelerator.
...
%
\begin{innerlist}
    \item C$+$$+$, Python, \Matlab, Mathematica, Lua, and others
\end{innerlist}
