...
\textit{Email:} \email{t.everett.ellis@gmail.com} & \textit{Phone:} +1-512-814-8304 \\
\textit{LinkedIn:} \href{https://www.linkedin.com/in/teverettellis/}{teverettellis}
...
Ph.D. in computational science, engineering, and mathematics with a background in aerospace engineering and an emphasis on advanced numerical methods for fluid simulations.
Familiarity with a variety of simulation domains including solid mechanics, electromagnetics, heat transfer, and plasma physics.
Experience running commercial CFD/CAE solvers as well as developing research codes for a wide range of applications.
Well developed programming and development skills (C/C++ and Python) with experience in parallel programming paradigms.
...
%
\textbf{Member of the Technical Staff} -- \emph{Scientific Software Development} \hfill {2018 to present}
\begin{innerlist}

\item[] \href{http://www.aerospace.org/}{Performance Modeling and Analysis Group,\\The Aerospace Corporation}
        % \href{http://www.utexas.edu/}{University of Texas at Austin}
\begin{innerlist}
\item Modernizing a parallel, C-based, multi-objective genetic algorithm optimization tool (GRIPS) with new features, bug fixes, and unit tests while assisting analysts
with new trade study formulations.
\item Validating high-fidelity propagaton capabilities of a C-based satellite coverage analysis tool (RevisitC) along with bug fixes, new features, and documentation.
% \item Supporting a C-based satellite coverage analysis tool (RevisitC) with new tests, bug fixes, and better documentation targeting high-fidelity propagaton.
\item Helping to rewrite legacy demand simulation tools in modern, parallel C++ (BLINE and PICS), design and implementation.
\item Leading a small team in the development of a Python based post-processing tool for GRIPS (GAPPS) including a major refactoring of the code base.
% \item Assisting analysts with the integration of new metrics and features in satellite constelllation studies conducted in GRIPS.
% \item Wrapped portions of a C++ high-fidelity formation flying code (hiffly) with a Python interface.
% \item Supporting
\end{innerlist}
\end{innerlist}
...
\item[] M.S.
        ...
        \item \emph{Summa cum Laude}, With Highest Honors
        \end{innerlist}
...
%
\begin{innerlist}
    \item C/C$+$$+$, Python, \Matlab, Mathematica, Lua, and others
\end{innerlist}
...
\textbf{Project Management Software:}
%
\begin{innerlist}
    \item JIRA, GitHub, GitLab, and others
\end{innerlist}
...
\begin{innerlist}
\item Asking the Next Best Question -- Aerospace, 2019
\item Crucial Conversations: Tools for Talking When Stakes are High -- Aerospace, 2019
\item Barely Sufficient Project Management: A Few Techniques for Improving Your Scientific Software Development Efforts -- Sandia, 2017
...
Computational fluid dynamics, shock physics, multi-phase flows, turbulence modeling, heat transfer,
finite element methods, Lagrangian hydrocodes,
computational plasma dynamics, magnetohydrodynamics, computational mechanics,
genetic algorithms, satellite constelllation design and optimization
